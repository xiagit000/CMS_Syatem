...
<body>
    ...
    <div class="class_title">新增投票</div>
    
    <form action="<s:url value='/admin/vote'/>" method="post" >
        <table class="info">
            <thead>
                <tr>
            ...
            <tbody>
                <tr class="odd">
                    <td>投票标题</td>
                    <td><input name="vote.title" class="w300" id="title" type="text"/>
                    <span id="titleVmsg" class="vmsg"></span><span class="vhint"><span>&#42;</span></span>
                    </td>
                </tr>
                <tr class="even">
                    <td>投票说明</td>
                    <td><input name="vote.content" class="w300" id="content" type="text"/>
