    ...
    <thead>
        ...
        <tr class="toolbar">
            <td colspan="5">
                ...
                <div class="row_left">
                   <input class="btn bw2" onclick="go('<s:url value="/admin/adword/new"/>')"
                    value="<s:text name='add'/>" type="button"/>
                </div>
                <s:if test="adwords.size != 0">
        ...
        <tbody>
        <s:if test="adwords.size != 0">
        <s:iterator value="adwords" var="entry" status="status">
            <tr class="${status.odd ? 'odd':'even'}">
                ...
                <td><a href="<s:url value='/admin/adword/%{id}/edit'/>">编辑</a> 
                         <a href="<s:url value='/admin/adword/%{id}/delete'/>"
                         onclick="return delConfirm();"><s:text name="delete"></s:text></a></td>
            </tr>
        </s:iterator>
        </s:if>
        <s:else>
