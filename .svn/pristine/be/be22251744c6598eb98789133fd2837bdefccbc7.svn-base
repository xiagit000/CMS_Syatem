...
setTimeout("top.location='<s:url value="/user/login"/>'",2000);
</script>
</head>
<body>
	<!--头部-->
    ...
    <!--注册信息-->
    	...
    	<div class="main">
			...
			<fieldset>
			<legend><s:text name="registerSuccess"/></legend>
			<div id="todo">
				<a href="<s:url value='/user/login'/>" target="_top"><s:text name="toLogin"/></a>
			</div>
			</fieldset>
			</form>
    		<!-- 登录表单 End -->
