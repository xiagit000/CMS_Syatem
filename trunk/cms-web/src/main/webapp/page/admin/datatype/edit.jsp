...
<title><s:text name="edit"/><s:text name="%{typename}"/></title></head>
<body>
...
<s:text name="edit"/><s:text name="%{typename}"/>
</div>
<form id="datatype_edit" action="update" method="post">
<table class="info">
	<thead>
		<tr>
		...
		<tr>
			...
			<td>
				<input class="w250" type="text" name="typeName" id="typeName"
					 value="<s:property value='currentType.name'/>" maxlength="7"/>
				<span id="nameVmsg" class="vmsg"></span>
				<span class="vhint">
					<span>&#42;</span><s:text name="%{typename}"/><s:text name="maxLength"><s:param>7</s:param></s:text>
					</span>
			</td>
		</tr>
	</tbody>
