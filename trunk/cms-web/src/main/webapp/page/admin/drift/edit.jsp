...
<form action="<s:url value='/admin/drift/%{drift.id}'/>" method="post" >
...
<table class="info">
    ...
    <tbody>
        <tr class="odd">
            <td>广告标题</td>
            <td><input name="drift.title" class="w300" id="title" type="text" value="${drift.title}"/>
            <span id="titleVmsg" class="vmsg"></span><span class="vhint"><span>&#42;</span></span>
            </td>
        </tr>
        <tr class="even">
            <td>广告内容</td>
            <td><input name="drift.content" class="w300" id="content" type="text" value="${drift.content}"/>
