...
<body>
    ...
    <div class="class_title">编辑交易量</div>

	<form action="<s:url value='/admin/deal-amount/%{dealAmount.id}'/>" method="post" >
		...
		<table class="info">
		    ...
		    <tbody>
		        <tr class="odd">
		            <td>公司名称</td>
		            <td><input name="dealAmount.company" class="w300" id="company" type="text" value="${dealAmount.company}"/>
		            <span id="companyVmsg" class="vmsg"></span><span class="vhint"><span>&#42;</span></span>
		            </td>
		        </tr>
                <tr class="even">
                    <td>金额总数</td>
                    <td><input name="dealAmount.totalAmountString" class="w300" id="totalAmount" type="text" value="${dealAmount.totalAmountString}"/>
                    <span id="totalAmountVmsg" class="vmsg"></span><span class="vhint"><span>&#42;</span></span>
                    </td>
                </tr>
		        <tr class="odd">
		            <td>百分比</td>
		            <td><input name="dealAmount.percent" class="w300" id="percent" type="text" value="${dealAmount.percent}"/> %
		        ...
		        <tr class="odd">
		            <td>排序值</td>
                    <td><input name="dealAmount.orderBy" class="w30" id="orderBy" type="text" value="${dealAmount.orderBy}"/>
